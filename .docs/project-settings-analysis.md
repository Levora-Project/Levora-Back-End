...
- Functions like `getConfiguredProviders()` are called during the static initialization of `src/modules/auth/auth.module.ts`. This occurs _before_ `ConfigModule` has fully instantiated and validated the variables.
